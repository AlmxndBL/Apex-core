...
Benchmark tooling and telemetry referenced in older entries lived in the separate Apex-eval repository and are not shipped in this repository. Historical entries are retained for release history; current capabilities are defined by the tracked files and package scripts.
