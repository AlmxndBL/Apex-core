...
> Evaluated at: `2026-08-26T09:45:52.593Z` | Framework Version: `v5.2.1` | Tokenizer: `cl100k_base (gpt-tokenizer BPE)`
...
|---|---|---|---|---|---|
| **01_backend_nitro.ts** | Backend & Database | **635 tok** | **138 tok** | **🔻 -78.3%** | 0.313ms |
| **02_frontend_view.vue** | Frontend UI/UX | **1858 tok** | **67 tok** | **🔻 -96.4%** | 0.137ms |
| **03_state_store.ts** | State Layer | **544 tok** | **69 tok** | **🔻 -87.3%** | 0.069ms |
| **04_schema.prisma** | Database Architecture | **399 tok** | **166 tok** | **🔻 -58.4%** | 0.161ms |
| **05_webhook_hmac.ts** | Security & Auth | **562 tok** | **95 tok** | **🔻 -83.1%** | 0.065ms |
...
| **Apex Surgical Patch Mode** (Rule 4 Exact Slice) | **176 tokens** | **🔻 -78.6% lower output** ($p < 0.0001$) | ✅ Exact character/line lock with In-RAM check |
